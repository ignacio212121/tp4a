...
func info_aparece():
	if $Base/PiernaDerecha.visible == true && $Base/PiernaIzquierda.visible == true && $Base/Cabeza2.visible == true && $Base/Torso2.visible == true && $Base/BrazoDerecho.visible == true && $Base/BrazoIzquierdo.visible == true:
		...
		$Base/PiernaD.visible = false
		$Base/PiernaI.visible = false
		$Base/BrazoD.visible = false
		$Base/BrazoI.visible = false
		$Base/Torso.visible = false
		$Base/Cabeza.visible = false
		$Timer.start()
		$Base/Titila.visible = false
