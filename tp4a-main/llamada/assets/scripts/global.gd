...
var colores: Array = [Color("#13DD0F"), Color("#E8007D"), Color("#707BE2"), Color("#9D08E8"), Color("#FF3D00")]
...
var contenido_llamadas = [
	...
	[{
	 ...
	 [{
		...
		"mensaje_usuario": " Bien. Ahora ¿podrías darme ideas de escenarios escolares para luego implementar al personaje?",
		"respuesta_ia": " *Respuesta*",
		"video": "actividad_03",
	}, {
		"titulo": "IA Y LA CREATIVIDA",
	...
	[{
		...
		"titulo": "",
		"mensaje_usuario": " Gracias por la ayuda.",
		"respuesta_ia": " Llamada Finalizada",
		"video": "actividad_06",
	}], ##########################################FIN NUCLEO 4 
	[{
