...
var actividad_05: PackedScene = preload("res://scenes/nucleo_04/actividad_05.tscn")
...
func _ready() -> void:
	array_actividades = [actividad_01.instantiate(), actividad_02.instantiate(), actividad_03.instantiate(), actividad_04.instantiate(), actividad_05.instantiate(), info_final.instantiate()]
	actividad_actual -= 1
